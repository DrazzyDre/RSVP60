  ...
  return (
    <div className="flex min-h-[50vh] flex-col items-center justify-center rounded-xl border border-dashed bg-white p-10 text-center">
      ...
      <p className="mt-2 max-w-sm text-sm text-muted-foreground">
        Create your first event to start building invite trees and collecting
        RSVPs. You can manage multiple events and switch between them anytime.
      </p>
      <Link href="/admin/events" className="mt-5">
        <Button>
