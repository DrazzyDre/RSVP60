...
export default function DashboardPage() {
  ...
  // Workspace-scoped hrefs for this event's pages.
  const base = selectedEventId ? `/admin/e/${selectedEventId}` : "/admin";
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="font-serif text-2xl font-bold text-royal">Overview</h1>
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        ...
        <StatCard
          ...
          href={`${base}/rsvps?status=accepted`}
        />
        <StatCard
          label="Declined"
          ...
          href={`${base}/rsvps?status=declined`}
        />
        <StatCard
          label="Waitlisted"
